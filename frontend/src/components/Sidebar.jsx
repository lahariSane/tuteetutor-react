          ...
          {Object.entries(topIcons).map(([key, value]) => (
            <ListItem sx={{ pl: 2 }} key={key} disablePadding width="100%">
              <SidebarListItemButton
                selected={
                  key.toLowerCase() === sidbarActive.toLowerCase() && !setHover
                } // Set selected state to true if key matches active sidebar item
              ...
              >
                <ListItemIcon sx={{ minWidth: 34 }}>{value}</ListItemIcon>
                <ListItemText
                  primary={key}
                  sx={{
                    "& .MuiTypography-root": {
      ...
      <Drawer
        ...
        sx={{
          ...
          "& .MuiDrawer-paper": {
            ...
            width: drawerWidth, // Remove box-shadow
            borderRight: "none",
          },
        }}
        open

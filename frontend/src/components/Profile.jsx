...
export default function Profile() {
  ...
  useEffect(() => {
    const fetchUserCourseData = async () => {
      try {
        ...
        const userCourseResponse = await axios.get(
        ...
        setProfileImage(
          personalInfoResponse.data.profileImage ||
            "https://via.placeholder.com/100"
        );
      } catch (error) {
  ...
  const handleSaveBio = async () => {
    try {
      await axios.put(
        `${process.env.REACT_APP_BACKEND_URL}/api/user/${userId}/bio`,
        { bio }
      );
          ...
          <div className="profile-container">
            ...
            <div className="profile-content">
              ...
              <div style={{ position: "relative", top: "-3em" }}>
                <h2
                  style={{ marginBottom: "0.3em", fontSize: "20px", margin: 0 }}
                >
                  Your Photo
                </h2>
                <p
        ...
        <div className="box-4">
          <div class="edit-courses-section">
            <div style={{ borderBottom: "2px solid #007bff" }}>
              ...
              >
                {" "}
                <b> Edit Your Courses and Section</b>
              </h2>
            </div>
            <form className="edit-info-form">
              <div class="form-group">
                <label className="edit-label" for="courses">
                  {" "}
                  <b>Courses:</b>
                </label>
                <select

                        ...
                        <form className="personal-info-form" style={{ marginTop: '1em' }}>
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    ...
                                    <input className='profile-input' type="text" id="fullName" placeholder="Full Name" />
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    <span className="icon">📧</span>
                                    <input className='profile-input' type="email" id="email" placeholder="Email" />
                                </div>
                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="input-wrapper">
                                    <input className='profile-input' type="text" id="role" placeholder="Role" />
                                </div>
                            </div>
                        </form>
                    </div>
